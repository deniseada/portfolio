...
- A interactive virtual blindbox simulation where users are able to click and choose which box they want to open.
- An animated unboxing experience where it maybe shakes or shows the motion of unboxing the box.
- Randomized smiski reveal based on rarity of each tiers.
- A collection tracker to indicate how many times the users have opened the same figure.
- Sound effects to maximize the user experience
- Maybe some sort of game to enable more excitement and wariness of choosing a box. (based on a points system.)
...
- Not getting the experience/enjoyment I wanted to achieve in the finished product.
