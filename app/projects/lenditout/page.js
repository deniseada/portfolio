        ...
        <section className={styles.tocSection}>
          ...
          <div className={styles.tocGrid}>
            ...
            <a href="#section-04" className={styles.tocItem}>
              ...
              <span className={styles.tocLabel}>WIREFRAMING</span>
            </a>
          ...
          <div className={styles.sectionContent}>
            <div className={styles.textCol}>
              ...
              <p>
                ...
                Most existing solutions are fragmented and do not provide clear
                pathways for listing, browsing, and finalizing transactions.
              </p>
          ...
          <div className={styles.sectionContent}>
            <div className={styles.textCol}>
              ...
              <p>
                ...
                guided visual hierarchy decisions and informed the high-priority
          ...
          <div className={styles.sectionContent}>
            <div className={styles.textCol}>
              <p>
                ...
                clarity of labels, visibility of important actions, and overall
                browsing confidence. The most frequent request was to simplify
                content density and make account status more obvious.
              </p>
            </div>
        ...
        <section id="section-04" className={styles.contentSection}>
          ...
          <div className={styles.sectionContentSingle}>
            <p className={styles.wireIntro}>
              Key wireframes focused on improving discoverability and supporting
              high-frequency tasks such as browsing bookmarks, viewing
              notifications, and checking order history.
            </p>
        ...
        <section id="section-05" className={styles.contentSection}>
          ...
          <div className={styles.sectionContent}>
            <div className={styles.textCol}>
              ...
              <p>
                The final product streamlines item browsing, profile management,
                and order tracking in one cohesive rental experience. Navigation
                is cleaner, trust indicators are more visible, and users can
                complete key actions faster with less confusion.
              </p>
              <h3 className={styles.subheading}>Reflection</h3>
              <p>
                This project strengthened my understanding of balancing visual
                design with practical flow. Iterative testing and feedback were
                essential in refining features while keeping the interface
