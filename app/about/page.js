            ...
            <div className={styles.heroGrid}>
              ...
              <div className={styles.heroText}>
                ...
                <div className={styles.heroLinks}>
                  ...
                  >
                    <svg width="24" height="24" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg" className={styles.linkIcon}>
                      <path d="M5.71942 28.5971C4.933 28.5971 4.25382 28.3231 3.68188 27.775C3.13377 27.203 2.85971 26.5238 2.85971 25.7374V8.57913C2.85971 7.79271 3.13377 7.12545 3.68188 6.57733C4.25382 6.00539 4.933 5.71942 5.71942 5.71942H28.5971C29.3835 5.71942 30.0508 6.00539 30.5989 6.57733C31.1709 7.12545 31.4568 7.79271 31.4568 8.57913V25.7374C31.4568 26.5238 31.1709 27.203 30.5989 27.775C30.0508 28.3231 29.3835 28.5971 28.5971 28.5971H5.71942ZM17.1583 18.5881L28.5971 11.4388V8.57913L17.1583 15.7284L5.71942 8.57913V11.4388L17.1583 18.5881Z" fill="#1D1B20"/>
                    </svg>
                    Deniseaquino011@gmail.com
                  </a>
                  <a className={styles.heroLink} href="https://linkedin.com">
                    <svg width="24" height="24" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg" className={styles.linkIcon}>
                      <path d="M22.8777 11.4389C25.1531 11.4389 27.3352 12.3427 28.9441 13.9516C30.553 15.5605 31.4569 17.7427 31.4569 20.018V30.027H25.7374V20.018C25.7374 19.2596 25.4361 18.5322 24.8998 17.9959C24.3635 17.4596 23.6362 17.1583 22.8777 17.1583C22.1193 17.1583 21.3919 17.4596 20.8556 17.9959C20.3193 18.5322 20.018 19.2596 20.018 20.018V30.027H14.2986V20.018C14.2986 17.7427 15.2025 15.5605 16.8114 13.9516C18.4203 12.3427 20.6024 11.4389 22.8777 11.4389Z" stroke="#1E1E1E" stroke-width="3.0027" stroke-linecap="round" stroke-linejoin="round"/>
                      <path d="M8.57917 12.8687H2.85974V30.027H8.57917V12.8687Z" stroke="#1E1E1E" stroke-width="3.0027" stroke-linecap="round" stroke-linejoin="round"/>
                      <path d="M5.71945 8.57917C7.29883 8.57917 8.57917 7.29883 8.57917 5.71945C8.57917 4.14008 7.29883 2.85974 5.71945 2.85974C4.14008 2.85974 2.85974 4.14008 2.85974 5.71945C2.85974 7.29883 4.14008 8.57917 5.71945 8.57917Z" stroke="#1E1E1E" stroke-width="3.0027" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    Linkedin
                  </a>
